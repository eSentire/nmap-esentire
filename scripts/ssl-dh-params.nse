...
local DHE_PRIMES = {
  ...
  ]])] = "mod_ssl 2.0.x/Hardcoded 512-bit prime",
  ...
  ]])] = "mod_ssl 2.0.x/Hardcoded 1024-bit prime",
  ...
  ]])] = "mod_ssl 2.2.x/Hardcoded 512-bit prime",
  ...
  ]])] = "mod_ssl 2.2.x/Hardcoded 1024-bit prime",
  ...
  ]])] = "nginx/Hardcoded 1024-bit prime",
  ...
  ]])] = "Java 7/Hardcoded 512-bit prime",
  ...
  ]])] = "Java 7/Hardcoded 768-bit prime",
  ...
  ]])] = "RFC5114/2048-bit MODP Group with 256-bit Prime Order Subgroup",
  ...
  ]])] = "WeakDH.org/Harvested 1024-bit prime #11"
}
